...
/**
 * Stack raíz: aloja los tabs (`MainTabs`) y apila por encima los detalles/altas/ediciones.
 * La transición entre features (Armario ↔ Outfits ↔ Perfil) la manejan los tabs; navegar a
 * un detalle desde una pantalla-tab lo empuja sobre la barra de tabs.
 */
